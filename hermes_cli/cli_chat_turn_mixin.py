...
class CLIChatTurnMixin:
    ...
    def _chat_run_agent(self, turn, message):
        ...
        self._arm_pending_one_turn_session_runtime(_one_turn_agent, _one_turn_model_restore)
        try:
            ...
            if _one_turn_model_restore:
                try:
                    ...
                    self._blocked_one_turn_model_restore = _one_turn_model_restore
                    logging.warning("One-turn model restore failed; future prompts are blocked: %s", exc)
