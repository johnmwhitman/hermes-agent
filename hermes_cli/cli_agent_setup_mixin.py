    ...
    def _init_agent(self, *, model_override: str = None, runtime_override: dict = None, request_overrides: dict | None = None) -> bool:
        ...
        try:
            ...
            self.agent = AIAgent(
                ...
                session_id=self.session_id, platform="a2a" if _a2a_policy is not None else "cli", session_db=self._session_db,
                clarify_callback=clarify_callback, a2a_policy=_a2a_policy,
