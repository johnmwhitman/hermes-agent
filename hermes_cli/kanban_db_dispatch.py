...
class DispatchResult:
    ...
    skills_refused: list[tuple[str, str]] = field(default_factory=list)
...
def _dispatch_lane_task(
    ...
    *,
    ...
    """
    task_id = row["id"]
    per_profile_cap = per_profile_caps.get(assignee, per_profile_cap)
    ...
    skills_error = _skills_preflight_check(claimed)
...
def _dispatch_once_locked(
    ...
    *,
    ...
    result = DispatchResult()
    per_profile_caps = _validate_profile_limit_overrides(max_in_progress_per_profile_overrides)
    ...
    lane_kwargs: dict[str, Any] = dict(
        ...
        per_profile_cap=per_profile_cap, per_profile_caps=per_profile_caps, per_profile_running=per_profile_running,
    )
