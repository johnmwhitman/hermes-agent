...
def _execute_tool(function_name: str, function_args: Dict[str, Any], original_args: Dict[str, Any], ids: _CallIds,
                  *, user_task: Optional[str], enabled_tools: Optional[List[str]], skip_tool_execution_middleware: bool,
                  a2a_posture: Optional[Dict[str, Any]] = None) -> Any:
    ...
    dispatch_kwargs: Dict[str, Any] = {
        ...
        "a2a_allowed_tool_names": set(a2a_posture.get("allowed_tool_names", ())) if a2a_posture is not None else None,
...
def handle_function_call(
    ...
    if bridged is not None:
        ...
        if underlying[0] == CONNECTOR_BATCH_SENTINEL:
            if a2a_posture is not None:
                return _emit(tool_error("Connector batch calls are not available under the A2A mutation posture"))
