...
@pytest.fixture(autouse=True)
def _kanban_closed_world(request, monkeypatch, _hermetic_environment):
    ...
    # The extracted defining module owns both connection caches and the
    # production-path trap. Do not eagerly import it for unrelated tests.
    _kb_mod = sys.modules.get("hermes_cli.kanban_db_connect")
