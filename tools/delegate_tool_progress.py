...
_COMPLETION_INSTRUCTIONS = (
    ...
    "Do NOT echo a tool-call plan as your final response; actually invoke the tool(s). "
    "Declaring completion without any tool call is treated as a silent failure by the parent.\n"
    "- Verify your own work: run requested checks rather than asserting their outcomes.\n\n"
