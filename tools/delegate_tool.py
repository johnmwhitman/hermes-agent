...
def _build_child_system_prompt(
    ...
    *,
    ...
    parts.append(
        ...
        "- You MUST make at least one tool call before returning your summary. "
        "Do NOT echo a tool-call plan as your final response; actually invoke "
        "the tool(s). Declaring completion without any tool call is treated as "
        "a silent failure by the parent.\n"
        "- Verify your own work: if the task says 'check that X exists' or "
        "'confirm Y', run the check yourself rather than asserting it.\n\n"
